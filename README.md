...
Forked from original author @Und3rf10w, I've editted the `installer.sh` scrip and added an autoamation function for instalation of latest packages, + some Stretch packages.
