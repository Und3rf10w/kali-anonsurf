...
# Check for resolvconf installation, make nesessary changes
if [[ ! -z `dpkg -l |grep resolvconf` ]]; then 
	echo -e "\e[33mDetected resolvconf installation\e[0m";
	# TODO: modify resolvconf_support value in /etc/anonsurf/init.d
fi
